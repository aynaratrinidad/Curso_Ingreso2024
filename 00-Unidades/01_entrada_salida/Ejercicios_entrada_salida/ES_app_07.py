...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert("Resultado de la suma", mensaje)
    ...
    def btn_restar_on_click(self):
        ...
        alert("Resultado de la resta", mensaje)
    ...
    def btn_multiplicar_on_click(self):
        ...
        alert("Resultado de la multiplicacion", mensaje)
    ...
    def btn_dividir_on_click(self):
        ...
        alert("Resultado de la division", mensaje)
