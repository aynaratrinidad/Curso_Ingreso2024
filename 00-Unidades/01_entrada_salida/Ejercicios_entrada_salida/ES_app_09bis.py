...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        incremento = float(incremento_str) / 100  
        sueldo_actualizado = sueldo * (1 + incremento)  
        mensaje = f"Sueldo actualizado con un {incremento * 100}% de incremento: {sueldo_actualizado:.2f}"
        alert("Sueldo Actualizado", mensaje)
