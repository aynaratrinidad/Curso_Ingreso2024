...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ingreso_edad = int(self.txt_edad.get())
        ingreso_tipo = self.combobox_tipo.get()

        if ingreso_edad >= 16 and ingreso_tipo == "NATIVO":
            mensaje = "Puede votar"
        elif ingreso_edad >= 18 and ingreso_tipo == "NATURALIZADO":
            mensaje = "Puede votar"
        else:
