...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        mensaje = f"{temperatura_celsius} °C equivalen a {round(temperatura_fahrenheit, 2)} °F"
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        mensaje = f"{temperatura_fahrenheit} °F equivalen a {round(temperatura_celsius, 2)} °C"
        alert("Conversión", mensaje)
